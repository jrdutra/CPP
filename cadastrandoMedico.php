...
<html>
    <head>
        ...
        <title>Cadastrando Medicos</title>
        ...
        <article>
            ...
            <div id="corpo">
                <div id="corpo-interno">
                    ...
                    $sql = mysqli_query($conexao,"INSERT INTO `$banco`.`medicos` (`id`,`nome`,`crm`) VALUES (NULL ,'$vNome','$vCrm');");
                    if($sql==1){
                        echo "<h3>Médico Cadastrado com Sucesso!</h3>
                                    ...
                                    <table>
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <label id=\"cCampo\">CRM: </label><label id=\"cVariavel\">$vCrm</label><br/>
                                            </td>
                        ...
                        echo "<h2>Falhou ao tentar cadastrar o médico!</h2>";
