...
<html>
    <head>
        ...
        <title>Cadastrande Remetentes</title>
        ...
        <article>
            ...
            <div id="corpo">
                <div id="corpo-interno">
                    ...
                    $sql = mysqli_query($conexao,"INSERT INTO `$banco`.`remetentes` (`id`,`nome`) VALUES (NULL ,'$vNome');");
                    if($sql==1){
                        echo "<h3>Entidade Remetente Cadastrada com Sucesso!</h3>
